...
sns.heatmap(cm_matrix, annot=True, fmt='d', xticklabels=xgb.classes_ , yticklabels=xgb.classes_)
...
# set the title of predic`ted probabilities
...
y_pred2 = xgb.predict_proba(X_test)[:, 2]
...
y_pred3 = xgb.predict_proba(X_test)[:, 3]
