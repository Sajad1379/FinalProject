...
print(sns.heatmap(cm_matrix, annot=True, fmt='d', cmap='Ylxgbu'))
...
print("# print classification accuracy")
...
Cross_validated_ROC_AUC = cross_val_score(xgb, X_train, y_train, cv=5, scoring='roc_auc').mean()
